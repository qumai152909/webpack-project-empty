module.exports = {
  ...
  plugins: [ // eslint插件:一般以eslint-plugin开头，写的时候可以省略eslint-plugin
    'eslint-plugin-react',
    'eslint-plugin-babel',
    'eslint-plugin-html',
  ...
  rules: { // 对规则进行细致的定义； 会覆盖extends中的规则； 错误等级有三级 0，1，2，分别代表off，warning，error
    'func-names': 0,
    'arrow-parens': 0,
    ...
    "javascript.implicitProjectConfig.experimentalDecorators": 'off',
  },
};
